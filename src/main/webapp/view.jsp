...
<html>
	...
	<body>
		<h2>Welcome, <s:property value="#session.userFName" /></h2>
		<h3>People</h3>
			...
			<ol>
				<s:iterator value="personList">
					<li>
						...
						<s:url action="editRegistration" var="editUrl">
							<s:param name="id" value="id"/>
						</s:url>
						<a href="<s:property value='#editUrl' />" >Edit</a>
						<s:token />
						<s:url action="deleteRegistration" var="deleteUrl" escapeAmp="false">
							<s:param name="id" value="id"/>
		...
		ActionSupport class (see struts.xml)  --%>   
		<s:url action="createRegistration" var="newUrl">
